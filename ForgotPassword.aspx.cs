...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)  // if validation was successful
        {
            ...
            string selectstatement = "select Security_Question,Security_answer from dbo.User_Information where Email='" + email + "';";
    ...
    protected void btnChangePassword_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
                ...
                string updatestatement = "update dbo.User_Information set Password='"+txtNewPassword.Text+"' where Email='" + txtEmailAddress.Text + "';";
