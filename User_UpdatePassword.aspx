<%@ Page Title="" Language="C#" MasterPageFile="~/UserSite.master" AutoEventWireup="true" CodeFile="User_UpdatePassword.aspx.cs" Inherits="UpdatePassword" %>
      ...
      <div class="subnav">
        ...
        <ul>
          <li> Update Profile</li>
            <ul>
                 <li><a href="MyProfile_User.aspx">Update Personal Info</a> </li>
              <li><a href="User_UpdatePassword.aspx">Change PrivacySettings</a> </li>
            </ul>
